...
I notice that if the file is over 25Mb, it cannot be downloaded completely with clone. I recommend downloading the lib/ folder and the test.zip compressed file separately.          
